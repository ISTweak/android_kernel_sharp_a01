					 ...
					 u16 *old_state)
{
	...
	if (pm8058_rev(kp->pm_chip) > PM_8058_REV_1p0) {
 	...
 	/* SHARP Add. use 1 Row Line. other key data clear. start */
#ifdef CONFIG_KEYBOARD_SCKEY
#if (defined(CONFIG_MACH_RYK) || defined(CONFIG_MACH_DECKARD_AF20))
	/* depend on target system */
...
{
#ifdef CONFIG_KEYBOARD_SCKEY
#if ( defined(CONFIG_MACH_BEC) || defined(CONFIG_MACH_RYK) || defined(CONFIG_MACH_DECKARD_AF20) )
	int row = 0;
	int CodeSendFlag = 0;
	int col, code;
	...
	return 0;
#else	/* defined(CONFIG_MACH_BEC) || defined(CONFIG_MACH_RYK) || defined(CONFIG_MACH_DECKARD_AF20) */
	int row = 0;
	int CodeSendFlag = 0;
	int col, code;
	...
	return 0;
#endif	/* defined(CONFIG_MACH_BEC) || defined(CONFIG_MACH_RYK) */
