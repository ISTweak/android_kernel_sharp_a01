...
/* [WLAN][SHARP] 2011.03.09 Mod for Model dependence GPIO current value Start */
#if defined(CONFIG_MACH_LYNX_DC40)
  ...
  #define WIFI_GPIO_VALUE GPIO_CFG_6MA
#endif
/* [WLAN][SHARP] 2011.03.09 Mod for Model dependence GPIO current value End */
...
static int wifipm_reset( struct device *pdev )
{
    ...
    btpm_wifi_reg( 0 );
#else
    printk( KERN_ERR "'CONFIG_BTPM' undeclared here!!\n" )
#endif
...
/* [WLAN][SHARP] 2011.03.18 tuned up startup sequence Start */
#if 0
		msleep(200);	/* over 200 ms */
#else
        msleep(20);
#endif
/* [WLAN][SHARP] 2011.03.18 tuned up startup sequence End */

		gpio_set_value( WIFIPM_PORT_WL_RESET_N, 1 );	/* WLAN_RST */
...
/* [WLAN][SHARP] 2011.03.18 tuned up shutdown sequence Start */
#if 0
		msleep(200);	/* over 200 ms */
#else
        msleep(1);
#endif
/* [WLAN][SHARP] 2011.03.18 tuned up shutdown sequence End */
