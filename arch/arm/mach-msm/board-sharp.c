...
#endif	/* CONFIG_MACH_DECKARD_AF20 */
...
#if defined(CONFIG_SENSORS_AMI602) || defined(CONFIG_MPU_SENSORS_MPU3050) || defined(CONFIG_SH_YAS530)
#else
...
#if defined(CONFIG_SENSORS_AMI602) || defined(CONFIG_MPU_SENSORS_MPU3050) || defined(CONFIG_SH_CAMERA) || defined(CONFIG_I2C_CUST_SH) || defined(CONFIG_SH_YAS530)
#else
GPIO_CFG(1, 0, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), /* VCM */
#endif	/* CONFIG_SENSORS_AMI602 || CONFIG_MPU_SENSORS_MPU3050 || CONFIG_SH_CAMERA || CONFIG_I2C_CUST_SH || CONFIG_SH_YAS530 */
};
...
{
	return sprintf(buf,
		__stringify(EV_KEY) ":" __stringify(KEY_MENU)   ":66:1001:80:60"
	":" __stringify(EV_KEY) ":" __stringify(KEY_HOME)   ":202:1001:80:60"
	":" __stringify(EV_KEY) ":" __stringify(KEY_BACK)   ":337:1001:80:60"
	":" __stringify(EV_KEY) ":" __stringify(KEY_SEARCH) ":472:1001:80:60"
	"\n");
}
...
#endif	/* defined( CONFIG_MACH_DECKARD_AF20 ) */
